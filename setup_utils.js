...
const
    ...
    AI_CAPTURE_INTENTION_DURATION = 5000 // <<< TOEGEVOEGD/GECONTROLEERD: Definitie van de constante >>>
;
...
// <<< GLOBALE VARIABELEN VOOR AI CAPTURE INTENTIE (NORMALE DEMO) >>>
let aiIntendsToBeCapturedByBossId = null;
let aiIntentionToCaptureStartTime = 0;
// AI_CAPTURE_INTENTION_DURATION is hierboven al bij de constanten toegevoegd.
