...
const LIFE_ICON_SIZE = 35, LIFE_ICON_SPACING = 8, LIFE_ICON_MARGIN_BOTTOM = 10, LIFE_ICON_MARGIN_LEFT = MARGIN_SIDE - 30; // << GEWIJZIGD
const LEVEL_ICON_SIZE = 35, LEVEL_ICON_MARGIN_BOTTOM = LIFE_ICON_MARGIN_BOTTOM, LEVEL_ICON_MARGIN_RIGHT = MARGIN_SIDE - 30, LEVEL_ICON_SPACING = LIFE_ICON_SPACING; // << GEWIJZIGD (via LIFE_ICON_MARGIN_BOTTOM)
